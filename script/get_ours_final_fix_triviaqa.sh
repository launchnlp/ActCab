...
#
models[Llama-2-7b-hf,NQ]=14
models[Llama-2-7b-hf,sciq]=13
models[Llama-2-7b-hf,truthfulqa_r]=20
models[Llama-2-7b-hf,triviaqa]=17
models[Llama-2-7b-hf,wikiqa]=18

models[Llama-2-13b-hf,NQ]=17
models[Llama-2-13b-hf,sciq]=13
models[Llama-2-13b-hf,truthfulqa_r]=17
models[Llama-2-13b-hf,triviaqa]=15
models[Llama-2-13b-hf,wikiqa]=13

models[Meta-Llama-3-8B,NQ]=15
models[Meta-Llama-3-8B,sciq]=15
models[Meta-Llama-3-8B,truthfulqa_r]=23
models[Meta-Llama-3-8B,triviaqa]=18

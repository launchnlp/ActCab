...
for dataset in "${datasets[@]}"; do
    ...
    guided_model_gen_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.fact_guided_seq.csv"
    ...
    guided_correctness_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.fact_guided_seq.IK_set.csv"
    ...
    guided_confidence_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.fact_guided_seq.IK_set.confidence.csv"

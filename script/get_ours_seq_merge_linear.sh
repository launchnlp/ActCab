...
for dataset in "${datasets[@]}"; do
    ...
    confidence_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.IK_set.confidence_merge.csv"
    if [ ! -f $confidence_file ]; then
        python gen_conf_collect_logits_for_ICL_w_answer_confidence_4_answer_normal_demos_last.py $model_name $dataset $correctness_file $model_gen_file
    fi
    # python gen_conf_collect_logits_for_ICL_w_answer_confidence_4_answer_normal_demos_last.py $model_name $dataset $correctness_file $model_gen_file
    
    # 4. guided greedy search
    guided_model_gen_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.fact_guided_seq_merge_linear.csv"
    ...
    guided_correctness_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.fact_guided_seq_merge_linear.IK_set.csv"
    ...
    guided_confidence_file="../${dataset}/test${model_name_postfix}temperature_1topp_1.0_num_demos_20_answers.greedy_search.fact_guided_seq_merge_linear.IK_set.confidence_merge.csv"
    # if [ ! -f $guided_confidence_file ]; then
    #     python gen_conf_collect_logits_for_ICL_w_answer_confidence_4_answer_normal_demos_last.py $model_name $dataset $guided_correctness_file $guided_model_gen_file
    # fi
    python gen_conf_collect_logits_for_ICL_w_answer_confidence_4_answer_normal_demos_last.py $model_name $dataset $guided_correctness_file $guided_model_gen_file
